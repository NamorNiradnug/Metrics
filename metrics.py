...
def euclidean_metric(point1: tuple, point2: tuple) -> float:
...
def discrete_metric(object1: object, object2: object) -> int:
    """Discrete metrics between objects is 1 if 'object1' == 'object2' else return 0."""
    return int(object1 == object2)


def hamming_distance(string1: object, string2: object) -> int:
